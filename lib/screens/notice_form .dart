...
class _NoticesState extends State<NoticeForm> {
              ...
              child: SizedBox(
                ...
                child: GestureDetector(
                  onTapDown: (_)async {
                    ...
                    if(subject != '' && body != ''){
                      dynamic upload = UploadNotice().upload(subject, body);
                        if(upload != null) {
                          _controller1.clear();
                          _controller2.clear();
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        ...
                        color: isActive?Colors.blue[700]:Colors.blue[700]
                    ),
